namespace Soloplan.WhatsON.Jenkins
{
  ...
  [SubjectType("Jenkins Build Job Status", Description = "Subjects of this type retrieve the current status of a Jenkins build job.")]
  [ConfigurationItem(JobName, typeof(string))]
  public class JenkinsBuildJobSubject : ServerSubject
  {
    public const string JobName = "JobName";

    public JenkinsBuildJobSubject(string serverAdress, string jobName, string serverPort = null, string name = null)
